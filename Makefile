...
&& source <(grep = ${AZURETRE_HOME}/$(2) | sed 's/ *= */=/g') \
...
copy-core-images:
	...
	$(call pull_image_to_devcontainer, "api", "api_app/_version.py", ${SOURCE_ACR_NAME})

	$(call login_acr, "Target", ${ARM_CLIENT_ID}, ${ARM_CLIENT_SECRET}, ${ARM_TENANT_ID}, ${ARM_SUBSCRIPTION_ID}, ${ACR_NAME})
	$(call push_image_from_devcontainer, "api", "api_app/_version.py", ${ACR_NAME})
