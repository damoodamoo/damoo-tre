...
echo "Pulling ${image_name} version ${version} from source..."

docker pull "${SOURCE_ACR_NAME}.azurecr.io/${1}/${image_name}:${version}"
docker image tag "${SOURCE_ACR_NAME}.azurecr.io/${1}/${image_name}:${version}" "${ACR_NAME}.azurecr.io/${1}/${image_name}:${version}"
